    ...
    <>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 4 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">
            4. 分析・パフォーマンスCookie（Google Analytics等）
          </h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="bg-light border border-gray-200 rounded-lg p-6 text-gray-700 leading-relaxed space-y-1">
            <p className="font-semibold text-navy">Arcrise Labo Inc.</p>
            <p>個人情報保護担当</p>
            <p>
              メール：
              <a
