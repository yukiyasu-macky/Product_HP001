    ...
    <>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 2. 情報セキュリティの定義 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">2. 情報セキュリティの定義</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 3. 組織的安全管理措置 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">3. 組織的安全管理措置</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 4. 技術的安全管理措置 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">4. 技術的安全管理措置</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 5. 物理的安全管理措置 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">5. 物理的安全管理措置</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 6. 人的安全管理措置 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">6. 人的安全管理措置</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 7. インシデント対応 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">7. インシデント対応</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 8. 継続的改善 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">8. 継続的改善</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
