    ...
    <>
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 1. 基本方針 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">第1条　基本方針</h2>
          ...
          {/* 2. 反社会的勢力の定義 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">第2条　反社会的勢力の定義</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            本方針において「反社会的勢力」とは、暴力、威力または詐欺的手法を用いて経済的利益を追求する個人または団体をいい、以下の者を含みます。
          </p>
          <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 space-y-2 pl-2">
            <li>暴力団</li>
          ...
          {/* 3. 対応原則（5原則） */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">第3条　対応原則（5原則）</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            当社は、反社会的勢力への対応にあたり、以下の5つの原則を徹底します。
          </p>
          <ol className="list-decimal list-inside text-gray-700 leading-relaxed mb-4 space-y-3 pl-2">
            <li>
              <span className="font-semibold text-navy">組織としての対応</span>
              <br />
              反社会的勢力からの不当要求に対し、担当者や担当部署が単独で判断・対処するのではなく、代表取締役を含む組織全体として統一的に対応します。
            </li>
            <li>
              <span className="font-semibold text-navy">外部専門機関との連携</span>
              <br />
              警察、暴力追放運動推進センター、弁護士等の外部専門機関と緊密に連携し、不当要求に対して適切かつ迅速に対処します。
            </li>
            <li>
              <span className="font-semibold text-navy">取引の全面遮断</span>
              <br />
              反社会的勢力との間では、いかなる名目や理由があっても、取引・契約・資金提供等の関係を一切持ちません。
            </li>
            <li>
              <span className="font-semibold text-navy">有事における民事・刑事両面での対応</span>
              <br />
              反社会的勢力による不当要求が発生した場合、民事上の法的手段と刑事上の告訴・告発を積極的に活用し、断固たる態度で対応します。
            </li>
            <li>
              <span className="font-semibold text-navy">裏取引・資金提供の禁止</span>
              <br />
              反社会的勢力から不当要求を受けた場合においても、業務への支障や個人の安全を理由とした裏取引や資金提供は、いかなる状況においても行いません。
            </li>
          </ol>

          {/* 4. 取引拒絶 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">第4条　取引拒絶</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 5. 法的措置 */}
          <h2 className="text-xl font-bold text-navy mt-8 mb-3">第5条　法的措置</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* 制定情報 */}
          <div className="border-t border-gray-200 mt-12 pt-8 text-right">
            <p className="text-gray-700">制定日：2026年5月1日</p>
            <p className="text-gray-700 mt-1">Arcrise Labo Inc.</p>
            <p className="text-gray-700">代表取締役　内海暢介</p>
          </div>
        </div>
      </section>
    </>
